...
[
  ...
  "OppListReader_valueByKeys_(row, headerMap, ['サブオーナー', '担当者', 'ユーザー'])",
  "OppListReader_valueByKeys_(row, headerMap, ['KeyDeal_最新'])",
  ...
  'MrrDashboard_periodFilterMatches_(targetFilter, legacyRow.completedMonth)',
  'keyDealsData: []',
  'MrrDashboard_getSnapshotPeriodFilterByDept_',
