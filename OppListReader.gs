...
function OppListReader_getLiveRows(deptKey) {
  ...
  values.forEach(function(row) {
    ...
    rows.push({
      oppId: oppId,
      completedMonth: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['完了月', '計上月'])),
      dept: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['担当部署'])),
      type: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['種別', '案件種別'])),
      subOwner: subOwner,
      ...
      scheduleOrCloseDate: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['開示予定日/受注日', '開示予定日 / 受注日'])),
      dealName: OppListReader_formatCell_(dealName),
      allocationPercent: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['按分率(%)'])),
      ...
      keyDeal: OppListReader_toBoolean_(OppListReader_valueByKeys_(row, headerMap, ['Key Deal フラグ', 'KeyDeal'])),
      fcstCommit: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['FCST(コミット)(換算値)', 'FCST(コミット)'])),
      fcstMin: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['FCST(MIN)(換算値)', 'FCST(MIN)'])),
      fcstMax: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['FCST(MAX)(換算値)', 'FCST(MAX)'])),
      received: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['受領'])),
      debtMgmt: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['債権管理', '債権管理回収'])),
      debtMgmtLite: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['債権管理Lite', '債権管理 Lite'])),
      expense: OppListReader_toNumber_(OppListReader_valueByKeys_(row, headerMap, ['経費'])),
      proposalProductIds: proposalIds,
      fcstComment: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['FCSTコメント'])),
      firstMeetingDate: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['初回MTG日', '初回面談日'])),
      summary: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['案件サマリ', '案件概要'])),
      optionFeatures: OppListReader_formatCell_(OppListReader_valueByKeys_(row, headerMap, ['オプション商材'])),
